...
class _$TagTearOff {
  ...
  _Tag call({required String name, String? description}) {
    return _Tag(
      name: name,
...
class _$_Tag with DiagnosticableTreeMixin implements _Tag {
  _$_Tag({required this.name, this.description});
...
abstract class _Tag implements Tag {
  factory _Tag({required String name, String? description}) = _$_Tag;
